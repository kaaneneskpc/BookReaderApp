package com.example.bookreaderapp.ui.screen.updateScreen
...
import com.example.bookreaderapp.utils.formatDate
...
fun ReaderBookUpdateScreen(
    ...
    Scaffold(topBar = {
        ...
        val bookInfo = produceState<DataOrException<List<Book>,
                Boolean,
                Exception>>(
...
@Composable
fun ShowBookUpdate(
    bookInfo: DataOrException<List<Book>,
